...
public class NoteVisionGRIP {
  ...
  public void process(Mat source0) {
    ...
    double[] hslThresholdHue = {8.093525179856115, 23.939393939393927};
    double[] hslThresholdSaturation = {224.73021582733813, 255.0};
    double[] hslThresholdLuminance = {0.0, 201.33838383838383};
    hslThreshold(
        hslThresholdInput,
        hslThresholdHue,
        hslThresholdSaturation,
        hslThresholdLuminance,
        hslThresholdOutput);
    ...
    double filterContoursMinArea = 165.0;
    double filterContoursMinPerimeter = 4.0;
    double filterContoursMinWidth = 10.0;
    double filterContoursMaxWidth = 355.0;
    double filterContoursMinHeight = 7.0;
    double filterContoursMaxHeight = 1000;
    double[] filterContoursSolidity = {75.53956834532374, 100.0};
  ...
  /**
   * Code used for CV_flip. Per OpenCV spec 0 -> flip on X axis. >0 -> flip on Y axis. <0 -> flip on
   * both axes.
   */
