...
public class ShotCalculator {
    ...
    /**
     * Calculates the robot angle for an automatic shot based
     * on robot pose and speed
     * 
     * @param robot The robot pose
    ...
    public static Rotation2d getShotAngle(Pose2d robot, ChassisSpeeds speed) {
        ...
        final Translation2d linearFieldVelocity = new Translation2d(speed.vxMetersPerSecond, speed.vyMetersPerSecond);
        ...
        Rotation2d goalHeading = robot.times(-1).transformBy(GeomUtil.translationToTransform(getGoal()))
