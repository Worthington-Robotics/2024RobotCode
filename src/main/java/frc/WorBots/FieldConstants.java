...
public class FieldConstants {
    ...
    public static void testField() {
        Logger.getInstance().logTranslation2d("Field", "Starting note wing 1", GamePieces.wing1);
        Logger.getInstance().logTranslation2d("Field", "Starting note wing 2", GamePieces.wing2);
        Logger.getInstance().logTranslation2d("Field", "Starting note wing 3", GamePieces.wing3);
        Logger.getInstance().logTranslation2d("Field", "Starting note far center", GamePieces.farCenter);
        Logger.getInstance().logTranslation2d("Field", "Starting note far high 1", GamePieces.farHigh1);
        Logger.getInstance().logTranslation2d("Field", "Starting note far high 2", GamePieces.farHigh2);
        Logger.getInstance().logTranslation2d("Field", "Starting note far low 1", GamePieces.farLow1);
        Logger.getInstance().logTranslation2d("Field", "Starting note far low 2", GamePieces.farLow2);
        ...
        Logger.getInstance().logTranslation2d("Field", "Subwoofer corner 1", Speaker.subwooferCorners[0]);
        Logger.getInstance().logTranslation2d("Field", "Subwoofer corner 2", Speaker.subwooferCorners[1]);
        Logger.getInstance().logTranslation2d("Field", "Subwoofer corner 3", Speaker.subwooferCorners[2]);
        Logger.getInstance().logTranslation2d("Field", "Subwoofer corner 4", Speaker.subwooferCorners[3]);
    }
    ...
    public static final class Speaker {
        public static final double subwooferY = fieldWidth - 5.547867999999999;
        ...
        public static final Translation2d[] subwooferCorners = new Translation2d[] {
                new Translation2d(subwooferDepth, subwooferY + subwooferSideLength / 2),
                new Translation2d(subwooferDepth, subwooferY - subwooferSideLength / 2),
                new Translation2d(0, subwooferY + subwooferBackLength / 2),
                new Translation2d(0, subwooferY - subwooferBackLength / 2),
        };
    }
    ...
    public static final class GamePieces {
        public static final Translation2d wing1 = new Translation2d(Units.inchesToMeters(114.0),
                fieldWidth / 2.0);
        public static final Translation2d wing2 = wing1
                .minus(new Translation2d(0.0, Units.inchesToMeters(57.0)));
        public static final Translation2d wing3 = wing2
                .minus(new Translation2d(0.0, Units.inchesToMeters(57.0)));
        public static final Translation2d[] wingPieces = new Translation2d[] { wing1, wing2, wing3 };
        public static final Translation2d farCenter = new Translation2d(fieldLength / 2.0, fieldWidth / 2.0);
        public static final Translation2d farHigh1 = farCenter
                .plus(new Translation2d(0.0, Units.inchesToMeters(66.0)));
        public static final Translation2d farHigh2 = farHigh1
                .plus(new Translation2d(0.0, Units.inchesToMeters(66.0)));
        public static final Translation2d farLow1 = farCenter
                .minus(new Translation2d(0.0, Units.inchesToMeters(66.0)));
        public static final Translation2d farLow2 = farLow1
                .minus(new Translation2d(0.0, Units.inchesToMeters(66.0)));
        public static final Translation2d[] farPieces = new Translation2d[] { farHigh2, farHigh1, farCenter, farLow1,
                farLow2 };
    }
